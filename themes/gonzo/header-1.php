...
<body>
	...
	<div class="topHeader" >
			...
			<div class="rightTopHeader">
				<div class="cartContainer">
					<div class="myCart">
						<ul>
							<li class="cartTitle">
									<a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/img/shop/cart.png" alt=""></a>
							</li>
						</ul>
					</div><!-- end myCart -->
				...
				<a class="open-menu">
					<!-- Buttons Bars -->
					<span style="color:#525252;">MENU</span>
				</a>
		...
		<div class="logo-container-top">
			<a href="/"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo/logo.png" alt="Aqura"></a>
