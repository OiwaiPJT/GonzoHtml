				...
				<div class="blog-left">
					<div class="col-sm-8">
						<div class="owl-carousel">
						    <div class="item"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/galPost.png" alt=""></div>
						    <div class="item"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/galPost.png" alt=""></div>
						</div>
						...
						<div class="author-info">
							<div class="left-author-info">
								<figure>
									<img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/blg1.png" alt="">
								</figure>
							</div>
								...
								<li>
									<div class="comment depth-1">
										<div class="left-section">
											<img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/author-avatar.jpg">
										</div>
					...
					<div class="col-sm-3 col-sm-offset-1">
						<div class="blogSidebar">
							...
							<div class="widget">
								...
								<!-- twitter -->
								<a class="twitter-timeline" href="https://twitter.com/nozawatakatomo">Tweets by nozawatakatomo</a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
							</div><!-- end widget -->
