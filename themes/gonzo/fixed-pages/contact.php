...
<!-- =============== END PLAYLIST ================ -->
	...
	<!-- =============== START CONTACT ================ -->
	<section class="contactSingle padding background-properties" id="content" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/subHeader/header.png);">
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
